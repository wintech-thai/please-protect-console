...
export default function ForgotPasswordView() {
  ...
  const formDictionary = {
    forms: {
      customerResetPassword: translations.customerResetPassword?.[lang],
      common: translations.common?.[lang],
  ...
  return (
    <div className="min-h-screen w-full flex items-start justify-center bg-[#020617] text-blue-100 font-sans relative overflow-hidden pt-20 md:pt-32 pb-8">
      ...
      <div className="relative z-10 w-full max-w-[450px] px-4">
        ...
        {/* Card Container */}
        <div className="bg-[#0B1120]/90 backdrop-blur-xl border border-blue-900/30 rounded-2xl shadow-2xl p-6 sm:p-8 relative overflow-hidden group">
