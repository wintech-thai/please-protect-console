...
export function ComingSoon({ title, description }: ComingSoonProps) {
  return (
    <div className="flex flex-col items-center justify-center w-full h-full text-center p-8 animate-in fade-in zoom-in duration-500">
      <div className="w-20 h-20 bg-slate-800/50 border border-slate-700/50 rounded-full flex items-center justify-center mb-6 shadow-inner">
